...
acf_add_local_field_group(array(
	'key' => 'group_5ff688160eb0b',
	'title' => 'Custom Template',
	'fields' => array(
		array(
			'key' => 'field_5ff68844c7760',
			'label' => 'Select Custom Template',
			'name' => 'select_custom_template',
			'type' => 'post_object',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	'location' => array(
		array(
			...
			array(
				'param' => 'post_template',
				'operator' => '==',
				'value' => 'custom-product-template.php',
			),
		),
	),
	'menu_order' => 0,
...
acf_add_local_field_group(array(
	'key' => 'group_6049f11370680',
	'title' => 'EDD Category Template',
	'fields' => array(
		array(
			'key' => 'field_6049f1465aeb8',
			'label' => 'Category Template',
			'name' => 'edd_category_template',
			'type' => 'post_object',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
