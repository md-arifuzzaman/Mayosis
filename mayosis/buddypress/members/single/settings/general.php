...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
	...
	<?php if ( !is_super_admin() ) : ?>
		...
		<label for="pwd"><?php _e( 'Current Password <span>(required to update email or change current password)</span>', 'mayosis' ); ?></label>
		<input type="password" name="pwd" id="pwd" size="16" value="" class="settings-input small" <?php bp_form_field_attributes( 'password' ); ?>/> &nbsp;<a href="<?php echo wp_lostpassword_url(); ?>"><?php _e( 'Lost your password?', 'mayosis' ); ?></a>

	<?php endif; ?>

	<label for="email"><?php _e( 'Account Email', 'mayosis' ); ?></label>
	...
	<label for="pass1"><?php _e( 'Change Password <span>(leave blank for no change)</span>', 'mayosis' ); ?></label>
	...
	<label for="pass2"><?php _e( 'Repeat New Password', 'mayosis' );
	?></label>
	...
	<div class="submit">
		<input type="submit" name="submit" value="<?php esc_attr_e( 'Save Changes', 'mayosis' ); ?>" id="submit" class="auto" />
	</div>
