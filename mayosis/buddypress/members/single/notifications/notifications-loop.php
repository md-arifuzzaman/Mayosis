<form action="" method="post" id="notifications-bulk-management">
	<table class="notifications">
		<thead>
			<tr>
				<th class="icon"></th>
				<th class="bulk-select-all"><label class="bp-screen-reader-text" for="select-all-notifications"><?php _e( 'Select all', 'mayosis' ); ?></label><input id="select-all-notifications" type="checkbox"></th>
				<th class="title"><?php _e( 'Notification', 'mayosis' ); ?></th>
				<th class="date"><?php _e( 'Date Received', 'mayosis' ); ?></th>
				<th class="actions"><?php _e( 'Actions',    'mayosis' ); ?></th>
			</tr>
		</thead>
